...
from pyproforma.calculation_engine import (
...
class TestCalculateSingleLineItem:
    ...
    def test_fixed_line_calculation(self):
        ...
        ns = ModelNamespace(li, AssumptionValues({}))
    ...
    def test_missing_line_item_raises_error(self):
        ...
        with pytest.raises(AttributeError):
            ...
            _calculate_single_line_item(TestModel.missing, ns, 2024)
...
class TestIntegrationWithProformaModel:
    ...
    def test_complex_model_integration(self):
        ...
        class ComplexModel(ProformaModel):
            ...
            tax = FormulaLine(formula=lambda li, t: li.ebitda[t] * li.tax_rate)
...
class TestFormulaLineEval:
    ...
    def test_eval_method_with_assumptions(self):
        ...
        li = LineItemValues(periods=[2024], names=["revenue", "expenses"])
        li.set("revenue", 2024, 100.0)
        ns = ModelNamespace(li, AssumptionValues({"expense_ratio": 0.65}))
    ...
    def test_eval_method_parameters_documented(self):
        """Test that eval() method signature clearly documents the two parameters."""
        ...
        # Should have self, ns, t parameters
        assert params == ["self", "ns", "t"]

        # Check annotations are present
        annotations = FormulaLine.eval.__annotations__
        assert "ns" in annotations
