...
class TestIndexToYearChart:
    ...
    def mock_model(self):
        ...
        # Mock index_to_year responses
        def mock_index_to_year(name, year, start_year=None):
        ...
        model.index_to_year.side_effect = mock_index_to_year
    ...
    def test_index_to_year_single_item(self, charts, mock_model):
        ...
        with patch.object(Chart, 'to_plotly') as mock_to_plotly:
            ...
            assert mock_model.index_to_year.call_count == 3  # Called for each year
    ...
    def test_index_to_year_multiple_items(self, charts, mock_model):
        ...
        with patch.object(Chart, 'to_plotly') as mock_to_plotly:
            ...
            assert mock_model.index_to_year.call_count == 6  # 2 items × 3 years
