...
class TestConstraintEvaluate:
    ...
    def test_evaluate_eq_operator_false(self):
        ...
        value_matrix = {
            2023: {"revenue": 99999.0, "expenses": 50000.0}
        }
    ...
    def test_evaluate_line_item_not_in_value_matrix(self):
        ...
        with pytest.raises(ValueError, match="Line item 'profit' not found in value_matrix for year 2023"):
    ...
    def test_evaluate_precision_with_floats(self):
        ...
        value_matrix = {
            2023: {"value": 0.3, "revenue": 100000.0}
        }
