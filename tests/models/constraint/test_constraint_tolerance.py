...
class TestConstraintTolerance:
    ...
    def test_tolerance_lt_with_buffer(self):
        ...
        value_matrix = {
            2023: {"revenue": 150000.0, "expenses": 98000.0},   # < target - tolerance (99000)
            2024: {"revenue": 150000.0, "expenses": 99500.0},   # > target - tolerance (99000)
    ...
    def test_tolerance_gt_with_buffer(self):
        ...
        value_matrix = {
            2023: {"revenue": 102000.0, "expenses": 50000.0},   # > target + tolerance (101000)
            2024: {"revenue": 100500.0, "expenses": 60000.0},   # < target + tolerance (101000)
    ...
    def test_tolerance_floating_point_precision(self):
        ...
        value_matrix = {
            2023: {"ratio": 0.1 + 0.2, "revenue": 100000.0}
        }
