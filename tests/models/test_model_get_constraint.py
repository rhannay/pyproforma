...
class TestModelGetConstraint:
    ...
    def test_get_constraint_valid_name(self, model_with_constraints: Model):
        ...
        constraint = model_with_constraints._constraint_definition("min_revenue")
    ...
    def test_get_constraint_with_dict_target(self, model_with_constraints: Model):
        ...
        constraint = model_with_constraints._constraint_definition("revenue_growth")
    ...
    def test_get_constraint_invalid_name(self, model_with_constraints):
        ...
        with pytest.raises(
            ...
            model_with_constraints._constraint_definition("nonexistent")
    ...
    def test_get_constraint_error_message_includes_valid_names(
        ...
        with pytest.raises(KeyError) as excinfo:
            model_with_constraints._constraint_definition("invalid_constraint")
    ...
    def test_get_constraint_from_model_with_no_constraints(
        ...
        with pytest.raises(KeyError, match="Valid constraint names are: \\[\\]"):
            model._constraint_definition("any_constraint")
    ...
    def test_get_constraint_returns_constraint_object(self, model_with_constraints):
        ...
        constraint = model_with_constraints._constraint_definition("max_expenses")
    ...
    def test_get_constraint_case_sensitive(self, model_with_constraints):
        ...
        with pytest.raises(KeyError):
            model_with_constraints._constraint_definition("Min_Revenue")
    ...
    def test_get_constraint_with_tolerance(self, basic_line_items, basic_categories):
        ...
        retrieved_constraint = model._constraint_definition("balance_check")
